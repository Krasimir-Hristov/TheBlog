...
const CommentSection = ({ postId }) => {
  ...
  return (
    <div className='max-w-2xl mx-auto w-full p-3'>
      {currentUser ? (
        <div className='flex items-center gap-1 my-5 text-gray-500 text-sm'>
          ...
          <Link
            ...
            className='text-xs text-cyan-600 hover:uppercase hover:underline'
          >
        ...
        <div className='text-sm text-teal-500 my-5 flex gap-2'>
          ...
          <Link
            className='text-red-500 hover:underline hover:uppercase '
            to='/sign-in'
          >
            Anmelden
          </Link>
        ...
        >
          ...
          <div className='flex justify-between items-center mt-5'>
            <p className='text-gray-500 text-sm'>
              {200 - comment.length} verbleibende Zeichen
            </p>
      ...
      {comments.length === 0 ? (
        <p className='text-sm my-5'>Keine Kommentare bisher!</p>
      ) : (
        <>
